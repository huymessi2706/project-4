            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form id="form-contact">
                        <div class="row">
                            <div class="col">
                                <input id="fullName" class="form-control" placeholder="Họ và tên">
                            </div>
                            <div class="col">
                                <input class="form-control" id="email" placeholder="Email">
                            </div>
                        </div>
                        <input class="form-control mt-3" id="phone" placeholder="Số điện thoại">
                        <input class="form-control mt-3" id="demand" placeholder="Nội dung">
...
<script>
    $('#btnSendContact').click(function(e){
        ...
        data['demand'] = document.getElementById('demand').value
